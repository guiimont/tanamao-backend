...
values
  ...
  (
    ...
    '{
      ...
      "policyTitle": "Politica comercial",
      "policyHeading": "Quanto mais voce organiza a semana, maior e o desconto",
      "policyIntro": "O beneficio e aplicado no total do carrinho. Voce ganha desconto por volume de itens e um bonus quando monta uma selecao mais variada para a rotina.",
      "policyButton": "Ver detalhes",
      "policyVolumeTitle": "Desconto por volume",
      "policyVolumeText": "3 itens: 3% | 5 itens: 6% | 8 itens: 9% | 12 itens: 12%.",
      "policyDiversityTitle": "Bonus por variedade",
      "policyDiversityText": "3 produtos diferentes: +1%. 5 produtos diferentes: +2%.",
      "policyLimitTitle": "Limite saudavel",
      "policyLimitText": "O desconto maximo e de 15%, preservando qualidade, frescor e producao sob encomenda.",
      "policyPaymentNote": "O pagamento e finalizado com seguranca pelo Mercado Pago, onde voce escolhe Pix, cartao ou outros meios disponiveis no checkout.",
